...
public class CardAdapter17 extends RecyclerView.Adapter<CardAdapter17.ViewHolder> {


    List<ListItem> items;
    Context mContext;

    public CardAdapter17(String[] names, String[] urls,String[] entrys,String[] genders,String[] years, Bitmap[] images,
    ...
    @Override
    public void onBindViewHolder(CardAdapter17.ViewHolder holder, final int position) {
