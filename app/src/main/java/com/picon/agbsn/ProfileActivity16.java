...
public class ProfileActivity16 extends AppCompatActivity {
    ...
    private void getData(){
        class GetData extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                progressDialog = ProgressDialog.show(ProfileActivity16.this, "Loading Entries", "Please wait...",true,true);
            ...
            protected String doInBackground(Void... params) {
                ...
                try {
                    ...
                    paras.add(new BasicNameValuePair("maglik",manglik));
    ...
    private void parseJSON(String json){
        try {
            ...
            JSONArray array = jso.getJSONArray(Config.TAG_JSON_ARRAY);
    ...
    private String getFathername(JSONObject j){
        String x = null;
        try {
            x =j.getString(Config.TAG_FATHER16);
        } catch (JSONException e) {
            e.printStackTrace();
        }
        return x;
    ...
    private String getMobile1(JSONObject j){
        String x = null;
        try {
            x =j.getString(Config.TAG_MOBILE16);
        } catch (JSONException e) {
            e.printStackTrace();
        }
        return x;
    ...
    private String getDob(JSONObject j){
        String x = null;
        try {
            x =j.getString(Config.TAG_DOB16);
        } catch (JSONException e) {
            e.printStackTrace();
        }
        return x;
    ...
    private String getDop(JSONObject j){
        String x = null;
        try {
            x =j.getString(Config.TAG_DOP16);
        } catch (JSONException e) {
            e.printStackTrace();
        }
        return x;
    ...
    private String getDot(JSONObject j){
        String x = null;
        try {
            x =j.getString(Config.TAG_DOT16);
        } catch (JSONException e) {
            e.printStackTrace();
        }
        return x;
    ...
    private String getState(JSONObject j){
        String x = null;
        try {
            x =j.getString(Config.TAG_STATE16);
        } catch (JSONException e) {
            e.printStackTrace();
        }
        return x;
    ...
    private String getCity(JSONObject j){
        String x = null;
        try {
            x =j.getString(Config.TAG_DISTRICT16);
        } catch (JSONException e) {
            e.printStackTrace();
        }
        return x;
    ...
    private String getAddress(JSONObject j){
        String x = null;
        try {
            x =j.getString(Config.TAG_ADDRESS16);
        } catch (JSONException e) {
            e.printStackTrace();
        }
        return x;
    ...
    private String getEducation(JSONObject j){
        String x = null;
        try {
            x =j.getString(Config.TAG_EDUCATION16);
        } catch (JSONException e) {
            e.printStackTrace();
        }
        return x;
    ...
    private String getOther(JSONObject j){
        String x = null;
        try {
            x =j.getString(Config.TAG_OTHEREDUCATION16);
        } catch (JSONException e) {
            e.printStackTrace();
        }
        return x;
    ...
    private String getCaste(JSONObject j){
        String x = null;
        try {
            x =j.getString(Config.TAG_SUBCAST16);
        } catch (JSONException e) {
            e.printStackTrace();
        }
        return x;
    ...
    private String getMarital(JSONObject j){
        String x = null;
        try {
            x =j.getString(Config.TAG_MARITAL16);
        } catch (JSONException e) {
            e.printStackTrace();
        }
        return x;
    ...
    private String getManglik(JSONObject j){
        String x = null;
        try {
            x =j.getString(Config.TAG_MANGLIK16);
        } catch (JSONException e) {
            e.printStackTrace();
        }
        return x;
    ...
    private String getHeight(JSONObject j){
        String x = null;
        try {
            x =j.getString(Config.TAG_HEIGHT16);
        } catch (JSONException e) {
            e.printStackTrace();
        }
        return x;
    ...
    private String getOccupation(JSONObject j){
        String x = null;
        try {
            x =j.getString(Config.TAG_OCCUPATION16);
        } catch (JSONException e) {
            e.printStackTrace();
        }
        return x;
